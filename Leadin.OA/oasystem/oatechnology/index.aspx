<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="index.aspx.cs" Inherits="Leadin.OA.oasystem.oatechnology.index" %>
                                    ...
                                    <table class="am-table am-table-striped am-table-hover table-main am-text-nowrap">
                                        <thead>
                                            <tr>
                                                ...
                                                <th class="table-numid">工艺编号</th>
                                                <th class="table-author">工艺名称</th>
                                                <th class="table-author">所属工艺</th>
                                                ...
                                                <ItemTemplate>
                                                    <tr>
                                                        ...
                                                        <td><a href="edit.aspx?id=<%# Eval("Id") %>"><%# Eval("NameInfo") %></a></td>
                                                         <td><%# GetParentName(int.Parse(Eval("ParentId").ToString())) %></td>
                                                         <td><%# Eval("Price").ToString()==""?"--":((decimal)Eval("Price")).ToString("0.00") %></td>
