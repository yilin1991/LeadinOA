<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="index.aspx.cs" Inherits="Leadin.OA.oasystem.oasupplier.index" %>
                                    ...
                                    <table class="am-table am-table-striped am-table-hover table-main am-text-nowrap">
                                        <thead>
                                            <tr>
                                                ...
                                                <th class="table-numid">供应商编号</th>
                                                <th class="table-author">供应商名称</th>
