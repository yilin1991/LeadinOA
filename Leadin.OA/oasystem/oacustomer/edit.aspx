<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="edit.aspx.cs" Inherits="Leadin.OA.oasystem.oacustomer.edit" %>
                            ...
                            <div class="am-u-sm-12 am-u-md-9">
                                <div class="am-form am-form-horizontal">
                                    <div class="am-form-group">
                                        <label for="txtCompanyName" class="am-u-sm-2 am-form-label">公司名称</label>
                                        <div class="am-u-sm-10">
                                            <asp:TextBox runat="server" ID="txtCompanyName" placeholder="请输入公司名称，必填" datatype="*" nullmsg="公司名称不能为空！"></asp:TextBox>
                                        </div>
                                    </div>
                                  
                                    <div class="am-form-group">
                                        <label for="ddlParentID" class="am-u-sm-2 am-form-label">所属公司</label>
                                        <div class="am-u-sm-10">
                                            <asp:DropDownList runat="server" ID="ddlParentID">
                                                <asp:ListItem Value="">请选择所属公司</asp:ListItem>
                                                 <asp:ListItem Value="0">直接客户</asp:ListItem>
                                            </asp:DropDownList>
                                        </div>
                                    </div>
                                    <div class="am-form-group">
                                    ...
                                    <div class="am-form-group">
                                        <label for="txtExplain" class="am-u-sm-2 am-form-label">客户简介</label>
                                        <div class="am-u-sm-10">
                                    ...
                                    <div class="am-form-group">
                                        <label for="user-QQ" class="am-u-sm-2 am-form-label">客户状态</label>
                                        <div class="am-u-sm-10">
