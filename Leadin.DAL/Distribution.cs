...
namespace Leadin.SQLServerDAL
{
	...
	/// 数据访问类:Distribution
	/// </summary>
	public partial class Distribution:IDistribution
	{
		public Distribution()
		{}
		#region  BasicMethod
		...
		public int GetMaxId()
		{
		return DbHelperSQL.GetMaxID("Id", "tb_Distribution"); 
		}
		...
		public bool Exists(int Id)
		{
			...
			strSql.Append("select count(1) from tb_Distribution");
		...
		/// 增加一条数据
		/// </summary>
		public int Add(Leadin.Model.Distribution model)
		{
			StringBuilder strSql=new StringBuilder();
		...
		/// 更新一条数据
		/// </summary>
		public bool Update(Leadin.Model.Distribution model)
		{
			StringBuilder strSql=new StringBuilder();
		...
		public bool Delete(int Id)
		{
			...
			StringBuilder strSql=new StringBuilder();
			strSql.Append("delete from tb_Distribution ");
			strSql.Append(" where Id=@Id");
			SqlParameter[] parameters = {
					new SqlParameter("@Id", SqlDbType.Int,4)
			};
		...
		public Leadin.Model.Distribution GetModel(int Id)
		{
			...
			Leadin.Model.Distribution model=new Leadin.Model.Distribution();
		...
		/// 得到一个对象实体
		/// </summary>
		public Leadin.Model.Distribution DataRowToModel(DataRow row)
		{
			Leadin.Model.Distribution model=new Leadin.Model.Distribution();
			if (row != null)
			{
				...
				if(row["SelectTel"]!=null)
				{
					model.SelectTel=row["SelectTel"].ToString();
				}
		...
		public DataSet GetListByPage(string strWhere, string orderby, int startIndex, int endIndex)
		{
			...
			strSql.Append(")AS Row, T.*  from tb_Distribution T ");
		...
		public DataSet GetList(int PageSize,int PageIndex,string strWhere)
		{
			...
			parameters[0].Value = "tb_Distribution";
