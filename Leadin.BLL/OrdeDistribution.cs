...
namespace Leadin.BLL
{
	...
	public partial class OrdeDistribution
	{
		...
		/// 获得数据列表
		/// </summary>
		public List<Leadin.Model.OrdeDistribution> GetModelList(string strWhere)
		{
		...
		/// 获得数据列表
		/// </summary>
		public List<Leadin.Model.OrdeDistribution> DataTableToList(DataTable dt)
		{
			List<Leadin.Model.OrdeDistribution> modelList = new List<Leadin.Model.OrdeDistribution>();
			int rowsCount = dt.Rows.Count;
			if (rowsCount > 0)
			{
				Leadin.Model.OrdeDistribution model;
