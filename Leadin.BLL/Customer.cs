...
namespace Leadin.BLL
{
	...
	public partial class Customer
	{
		...
		/// 获得数据列表
		/// </summary>
		public List<Leadin.Model.Customer> GetModelList(string strWhere)
		{
		...
		/// 获得数据列表
		/// </summary>
		public List<Leadin.Model.Customer> DataTableToList(DataTable dt)
		{
			List<Leadin.Model.Customer> modelList = new List<Leadin.Model.Customer>();
			int rowsCount = dt.Rows.Count;
			if (rowsCount > 0)
			{
				Leadin.Model.Customer model;
        ...
        public string SetNumID()
        {
            ...
            Model.Customer model = GetModel(GetMaxId());
            if (model != null)
            {
