...
namespace Leadin.BLL
{
	...
	public partial class PublicVersion
	{
		...
		/// 获得数据列表
		/// </summary>
		public List<Leadin.Model.PublicVersion> GetModelList(string strWhere)
		{
		...
		/// 获得数据列表
		/// </summary>
		public List<Leadin.Model.PublicVersion> DataTableToList(DataTable dt)
		{
			List<Leadin.Model.PublicVersion> modelList = new List<Leadin.Model.PublicVersion>();
			int rowsCount = dt.Rows.Count;
			if (rowsCount > 0)
			{
				Leadin.Model.PublicVersion model;
        ...
        public string SetNumID()
        {
            ...
            Model.PublicVersion model = GetModel(GetMaxId());
            if (model != null)
            {
