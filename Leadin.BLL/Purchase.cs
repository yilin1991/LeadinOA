...
namespace Leadin.BLL
{
	...
	public partial class Purchase
	{
		...
		/// 获得数据列表
		/// </summary>
		public List<Leadin.Model.Purchase> GetModelList(string strWhere)
		{
		...
		/// 获得数据列表
		/// </summary>
		public List<Leadin.Model.Purchase> DataTableToList(DataTable dt)
		{
			List<Leadin.Model.Purchase> modelList = new List<Leadin.Model.Purchase>();
			int rowsCount = dt.Rows.Count;
			if (rowsCount > 0)
			{
				Leadin.Model.Purchase model;
