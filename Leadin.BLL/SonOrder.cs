...
namespace Leadin.BLL
{
	...
	public partial class SonOrder
	{
		...
		/// 获得数据列表
		/// </summary>
		public List<Leadin.Model.SonOrder> GetModelList(string strWhere)
		{
		...
		/// 获得数据列表
		/// </summary>
		public List<Leadin.Model.SonOrder> DataTableToList(DataTable dt)
		{
			List<Leadin.Model.SonOrder> modelList = new List<Leadin.Model.SonOrder>();
			int rowsCount = dt.Rows.Count;
			if (rowsCount > 0)
			{
				Leadin.Model.SonOrder model;
