...
namespace Leadin.BLL
{
	...
	public partial class Category
	{
		...
		/// 获得数据列表
		/// </summary>
		public List<Leadin.Model.Category> GetModelList(string strWhere)
		{
		...
		/// 获得数据列表
		/// </summary>
		public List<Leadin.Model.Category> DataTableToList(DataTable dt)
		{
			List<Leadin.Model.Category> modelList = new List<Leadin.Model.Category>();
			int rowsCount = dt.Rows.Count;
			if (rowsCount > 0)
			{
				Leadin.Model.Category model;
