...
namespace Leadin.BLL
{
	...
	public partial class Technology
	{
		...
		/// 获得数据列表
		/// </summary>
		public List<Leadin.Model.Technology> GetModelList(string strWhere)
		{
		...
		/// 获得数据列表
		/// </summary>
		public List<Leadin.Model.Technology> DataTableToList(DataTable dt)
		{
			List<Leadin.Model.Technology> modelList = new List<Leadin.Model.Technology>();
			int rowsCount = dt.Rows.Count;
			if (rowsCount > 0)
			{
				Leadin.Model.Technology model;
