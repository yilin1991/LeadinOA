...
namespace Leadin.BLL
{
	...
	public partial class OrdeChange
	{
		...
		/// 获得数据列表
		/// </summary>
		public List<Leadin.Model.OrdeChange> GetModelList(string strWhere)
		{
		...
		/// 获得数据列表
		/// </summary>
		public List<Leadin.Model.OrdeChange> DataTableToList(DataTable dt)
		{
			List<Leadin.Model.OrdeChange> modelList = new List<Leadin.Model.OrdeChange>();
			int rowsCount = dt.Rows.Count;
			if (rowsCount > 0)
			{
				Leadin.Model.OrdeChange model;
